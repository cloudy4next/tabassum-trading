<x-native::layout.login>
    <x-native::layout.auth-card>
        ...
        <form method="POST" action="{{ route('password.reset.update') }}">
            ...
            {{-- <x-native::utils.error :messages="$errors->get('email')" class="mt-2" /> --}}
            ...
            {{-- <x-native::utils.error :messages="$errors->get('password')" class="mt-2" /> --}}
            ...
            <div class="input-group mb-3">
                ...
                <x-native::utils.error :messages="$errors->get('password_confirmation')" class="mt-2"/>
